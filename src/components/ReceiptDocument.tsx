...
export function ReceiptDocument({
  ...
  return (
    <article className="receipt-doc overflow-hidden border border-black bg-white text-[11px] text-black shadow-sm print:text-[10px] print:shadow-none">
      <p className="border-b border-black px-3 py-1.5 text-[10px] italic text-neutral-700 print:text-[9px]">
      ...
      <div className="space-y-3 px-2 py-3 print:space-y-2">
        <LinesTable
        ...
        />
        <p className="px-1 text-[10px] text-neutral-600">
        ...
        <p className="border border-black bg-neutral-100 px-2 py-1.5 text-[10px] leading-snug">
          ...
          {signed ? (
            <div className="space-y-1">
              ...
              <img
                ...
                className="max-h-24 max-w-full border border-neutral-400 bg-white print:max-h-20"
              />
            </div>
          ) : (
