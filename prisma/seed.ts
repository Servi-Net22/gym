  ...
  await prisma.content.createMany({
    data: [
      ...
      },
      {
        organizationId: org.id,
        type: "rutina",
        title: "Fuerza intermedia (3 días)",
        body: "Día A (empuje): banca 4x6, militar 3x8, fondos 3x10.\nDía B (tirón): peso muerto rumano 4x6, remo 4x8, jalón 3x10.\nDía C (piernas): sentadilla 4x6, zancadas 3x10, gemelos 3x12.\nDescanso 90–120s entre series.",
        clientId: null,
        level: "intermedio",
        gender: "mujer",
        daysPerWeek: 3,
